...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    ...
    [self.navigationItem setLeftBarButtonItem:[[UIBarButtonItem alloc] initWithImage:[UIImage imageNamed:@"threelinebutton"] style:UIBarButtonItemStyleBordered target:self action:@selector(onBack)]];
}
