...
- (IGRequest*)openUrl:(NSString *)url
    ...
    if ([self isSessionValid]) {
        ...
        [params setValue:self.username forKey:@"user.fullname"];
    }
...
- (BOOL)handleOpenURL:(NSURL *)url {
    ...
    NSString *username = [params valueForKey:@"user.fullname"];
    ...
    [self igDidLogin:accessToken User:username];
    return YES;
}
 ...
 */
- (void)igDidLogin:(NSString *)token User:(NSString *)username/*expirationDate:(NSDate *)expirationDate*/ {
